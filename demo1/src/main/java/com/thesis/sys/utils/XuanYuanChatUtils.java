package com.thesis.sys.utils;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.thesis.config.XuanYuanConfig;
import com.thesis.constant.XuanYuanModel;
...
//TODO:当前类中的方法只适配了一种模型，需要更多的方法以及调用链来适配更多的模型
@Component
@Slf4j
public class XuanYuanChatUtils {
    ...
    //模型的一些默认值
    //TODO:对于不同的模型有不同的默认值，所以需要抽取出来
    private final Double XUANYUAN_4bit_DEFAULT_TEMPERATURE = 0.8;
    private final Double XUANYUAN_4bit_DEFAULT_TOP_P = 0.8;
    private final Double XUANYUAN_4bit_DEFAULT_PENALTY_SCORE = 1.0;
    private final Boolean XUANYUAN_4bit_DEFAULT_STREAM = false;
    ...
    public Response getERNIEBot40ChatStream(Integer userId,
        ...
        Request request = new Request.Builder()
                .url(XuanYuanModel.getUrl(XuanYuanModel.XuanYuan_4bit) + "?access_token=" + xuanYuanConfig.flushAccessToken())
                .method("POST", body)
    ...
    public Response getERNIEBot40ChatStream(Integer userId,LinkedList<Map<String,String>> messages){
        return this.getERNIEBot40ChatStream(userId,XUANYUAN_4bit_DEFAULT_TEMPERATURE,XUANYUAN_4bit_DEFAULT_PENALTY_SCORE,XUANYUAN_4bit_DEFAULT_STREAM,messages);
    }
    ...
    public Response getERNIEBot40ChatStream(Integer userId, LinkedList<Map<String,String>> messages, Boolean stream){
        return this.getERNIEBot40ChatStream(userId,XUANYUAN_4bit_DEFAULT_TEMPERATURE,XUANYUAN_4bit_DEFAULT_PENALTY_SCORE,stream,messages);
    }
